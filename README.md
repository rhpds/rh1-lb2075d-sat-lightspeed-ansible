# rh1-lb2075d-sat-lightspeed-ansible
...
**Owner:** myee111
**Migrated from:** https://github.com/rhpds/zt-satellite-lightspeed-ansible
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/rh1-lb2075d-sat-lightspeed-ansible`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/rh1-lb2075d-sat-lightspeed-ansible
   ```
3. `cd rh1-lb2075d-sat-lightspeed-ansible`
